...
<head>
    ...
    <style>
        ...
        * {
        ...
        .live-set-create-hero {
            padding: 18px 22px;
            min-height: 0;
        }

        .live-set-create-hero .library-hero-copy {
            max-width: 620px;
        }

        .live-set-create-hero h1 {
            margin-top: 6px;
            max-width: 9ch;
        ...
        .live-set-create-hero .library-hero-actions .button {
            min-height: 48px;
            min-width: 0;
            padding-inline: 18px;
        }
        ...
        .live-set-form-shell .studio-grid {
            gap: 16px;
        }

        .live-set-form-shell label {
            gap: 8px;
        }

        .live-set-form-shell input {
            min-height: 50px;
            padding: 12px 15px;
        }
        ...
        .live-set-form-shell .live-song-list,
        .live-set-form-shell .live-set-selection {
            gap: 10px;
        }
        ...
        .live-set-form-shell .live-song-option > div {
            gap: 8px;
        }

        .live-set-form-shell .live-song-option h3,
        .live-set-form-shell .live-set-item-copy strong {
            font-size: 0.98rem;
        }

        .live-set-form-shell .song-meta {
            font-size: 0.74rem;
        }
        ...
        .live-set-form-shell .live-set-empty {
            gap: 8px;
            padding: 16px;
        }

        .live-set-form-shell .live-set-empty h2 {
            font-size: 1.18rem;
        }

        .live-set-form-shell .live-set-empty p,
        .live-set-form-shell .live-set-item-copy small {
            font-size: 0.9rem;
        }
